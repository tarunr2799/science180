	...
	<div class="inside">
			...
			<tr valign="top">
				...
				<td>
					<div class="aiowps_switch_container">
						<?php AIOWPSecurity_Utility_UI::setting_checkbox(sprintf(__('Enable this if you want to insert CAPTCHA on a %s login form.', 'all-in-one-wp-security-and-firewall'), 'WooCommerce'), 'aiowps_enable_woo_login_captcha', '1' == $aiowps_enable_woo_login_captcha); ?>
					</div>
				</td>
			</tr>
		</table>
		...
		<table class="form-table">
			<tr valign="top">
				...
				<td>
					<div class="aiowps_switch_container">
						<?php AIOWPSecurity_Utility_UI::setting_checkbox(sprintf(__('Enable this if you want to insert CAPTCHA on a %s lost password form.', 'all-in-one-wp-security-and-firewall'), 'WooCommerce'), 'aiowps_enable_woo_lostpassword_captcha', '1' == $aiowps_enable_woo_lostpassword_captcha); ?>
					</div>
				</td>
			</tr>
		</table>
		...
		<table class="form-table">
			<tr valign="top">
				...
				<td>
					<div class="aiowps_switch_container">
						<?php AIOWPSecurity_Utility_UI::setting_checkbox(sprintf(__('Enable this if you want to insert CAPTCHA on a %s registration form.', 'all-in-one-wp-security-and-firewall'), 'WooCommerce'), 'aiowps_enable_woo_register_captcha', '1' == $aiowps_enable_woo_register_captcha); ?>
					</div>
				</td>
			</tr>
		</table>
		...
		<table class="form-table">
			<div class="<?php echo $is_enabled_guest_checkout ? "aio_blue_box" : "aio_red_box"; ?>">
				<p>
					<?php
					if (!$is_enabled_guest_checkout) {
			...
			<tr valign="top">
				...
				<td>
					<div class="aiowps_switch_container">
						<?php AIOWPSecurity_Utility_UI::setting_checkbox(sprintf(__('Enable this if you want to insert a CAPTCHA on the %s checkout page when a guest places an order.', 'all-in-one-wp-security-and-firewall'), 'WooCommerce'), 'aiowps_enable_woo_checkout_captcha', '1' == $aiowps_enable_woo_checkout_captcha, $checkout_checkbox_attributes); ?>
					</div>
				</td>
			</tr>
		</table>
